...
func TestAccDataSourceAbrhaImages_Basic(t *testing.T) {
	config := `
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.abrha_images.ubuntu", "images.#"),
					acceptance.TestResourceInstanceState("data.abrha_images.ubuntu", testAccDataSourceAbrhaImages_VerifyImageData),
				),
			},
		},
	})
...
func testAccDataSourceAbrhaImages_VerifyImageData(is *terraform.InstanceState) error {
