...
func TestAccAbrhaMonitorAlert_importBasic(t *testing.T) {
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: fmt.Sprintf(testAccAlertPolicy, randName, randName, "", "10m", "api/public/v1/insights/vm/memory_utilization_percent", randName),
			},
			{
