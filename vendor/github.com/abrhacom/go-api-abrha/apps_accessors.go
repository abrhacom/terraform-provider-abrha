...
func (d *DeploymentCauseDetailsAbrhaUser) GetEmail() string {
	if d == nil {
		return ""
	}
	return d.Email
...
func (d *DeploymentCauseDetailsAbrhaUser) GetUUID() string {
	if d == nil {
		return ""
	}
	return d.UUID
...
// GetName returns the Name field.
func (d *DeploymentCauseDetailsAbrhaUserAction) GetName() DeploymentCauseDetailsAbrhaUserActionName {
	if d == nil {
		return ""
	}
	return d.Name
...
func (d *DeploymentCauseDetailsAbrhaUserAction) GetUser() *DeploymentCauseDetailsAbrhaUser {
	if d == nil {
		return nil
	}
	return d.User
