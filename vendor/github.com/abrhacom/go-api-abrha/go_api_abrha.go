...
const (
	...
	defaultBaseURL = "https://my.abrha.net/cserver/"
	userAgent      = "go-api-abrha/" + libraryVersion
	...
	internalHeaderRetryAttempts = "X-Go-Api-Abrha-Retry-Attempts"
...
// NewFromToken returns a new Abrha API client with the given API
// token.
...
// NewClient returns a new Abrha API client, using the given
// http.Client to perform all requests.
//
// Users who wish to pass their own http.Client should use this method. If
// you're in need of further customization, the go-api-abrha.New method allows more
...
func NewClient(httpClient *http.Client) *Client {
	...
	c.Vms = &VmsServiceOp{client: c}
	c.VmActions = &VmActionsServiceOp{client: c}
	c.VmAutoscale = &VmAutoscaleServiceOp{client: c}
...
func New(httpClient *http.Client, opts ...ClientOpt) (*Client, error) {
	...
	if c.RetryConfig.RetryMax > 0 {
		...
		// with a *goApiAbrha.ErrorResponse and a non-nil *goApiAbrha.Response while providing
