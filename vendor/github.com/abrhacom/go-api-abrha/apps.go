...
const (
	appsBasePath = "/api/public/v1/apps"
)
...
//     go_api_abrha.ForEachAppSpecComponent(spec, func(component go_api_abrha.AppBuildableComponentSpec) error { ... })
//   - struct type constraint
//     go_api_abrha.ForEachAppSpecComponent(spec, func(component *goApiAbrha.AppStaticSiteSpec) error { ... })
...
// Examples:
//   - interface constraint
//     goApiAbrha.GetAppSpecComponent[goApiAbrha.AppBuildableComponentSpec](spec, "component-name")
//   - struct type constraint
//     goApiAbrha.GetAppSpecComponent[*goApiAbrha.AppServiceSpec](spec, "component-name")
